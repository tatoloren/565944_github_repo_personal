...
def main():
    ...
    # datos es la lista de diccionarios 
    ...
    RATE = 1410
    salarios_ars = [ {"salary_usd":d["salary"] , "salary_ars": d['salary'] * RATE } for d in datos ]  # ← reemplazá esto con una lista por comprensión
    print(tabulate(salarios_ars[:5], headers="keys", tablefmt="grid", ))

    salarios_ars = [ d["salary"] * RATE for d in datos ]  # ← reemplazá esto con una lista por comprensión
